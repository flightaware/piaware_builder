...
clone_or_update https://github.com/flightaware/dump1090.git v3.8.1 $OUTDIR/dump1090

clone_or_update https://github.com/mutability/mlat-client.git v0.2.11 $OUTDIR/mlat-client

clone_or_update https://github.com/flightaware/dump978.git v3.8.1 $OUTDIR/dump978
