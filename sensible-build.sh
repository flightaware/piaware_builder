...
clone_or_update https://github.com/flightaware/piaware.git 3.6.2 $OUTDIR/piaware

clone_or_update https://github.com/flightaware/tcllauncher.git v1.8 $OUTDIR/tcllauncher

clone_or_update https://github.com/flightaware/dump1090.git 3.6.2 $OUTDIR/dump1090
