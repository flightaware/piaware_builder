...
clone_or_update https://github.com/flightaware/dump1090.git origin/master $OUTDIR/dump1090

clone_or_update https://github.com/mutability/mlat-client.git origin/master $OUTDIR/mlat-client
