...
clone_or_update https://github.com/flightaware/dump1090.git v3.7.0 $OUTDIR/dump1090

clone_or_update https://github.com/mutability/mlat-client.git v0.2.10 $OUTDIR/mlat-client

clone_or_update https://github.com/flightaware/dump978.git v3.7.0 $OUTDIR/dump978
