...
shallow_clone https://github.com/flightaware/piaware.git v7.2 $OUTDIR/piaware

shallow_clone https://github.com/flightaware/tcllauncher.git v1.8 $OUTDIR/tcllauncher

shallow_clone https://github.com/flightaware/dump1090.git v7.2 $OUTDIR/dump1090

shallow_clone https://github.com/mutability/mlat-client.git v0.2.12 $OUTDIR/mlat-client

shallow_clone https://github.com/flightaware/dump978.git v7.2 $OUTDIR/dump978
