...
clone_or_update https://github.com/flightaware/piaware.git origin/staging $OUTDIR/piaware

clone_or_update https://github.com/flightaware/tcllauncher.git v1.8 $OUTDIR/tcllauncher

clone_or_update https://github.com/flightaware/dump1090.git origin/staging $OUTDIR/dump1090

clone_or_update https://github.com/mutability/mlat-client.git origin/staging $OUTDIR/mlat-client
